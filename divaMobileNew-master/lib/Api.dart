...
// static final String url = dotenv.env['API_BASE_URL'] ?? 'http://default_url';
  static const url = 'http://192.168.1.19:8000/api';
...
/**************************************chat **********************************************/
static String getConversationMessages(int conversationId) => '$url/conversations/$conversationId/messages';
static final String getAllUsers = url + '/users';
...
/*********************************************** Chiffre Affaire url ***************************/
  ...
  static final String CA_getCA_ShowRoom =
      url + "/ChiffreAffaire/getCA_ShowRoom";
  static final String CA_getCA_ShowRoom_detail =
      url + "/ChiffreAffaire/getCA_ShowRoom_detail";
...
/************************************** etat de retour ******************************************/
  ...
  static final String getRetour_ART_Entete =
      url + "/Retour/getRetour_ART_Entete";
  static final String getRetour_ART_Ligne = url + "/Retour/getRetour_ART_Ligne";
  static final String getRetour_REP_Entete =
      url + "/Retour/getRetour_REP_Entete";
