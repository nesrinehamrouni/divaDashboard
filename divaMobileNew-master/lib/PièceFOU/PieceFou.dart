...
import '../pieceCLI/dropdown_Etat.dart';
import '../pieceCLI/dropdown_PICOD.dart';
...
class PieceFOU extends StatefulWidget {
  const PieceFOU({super.key}) ;


  @override
  State<PieceFOU> createState() => _ExampleAppPageState();
}

class _ExampleAppPageState extends State<PieceFOU> {
  ...
  static const String _title = " Consultation Pièces Fournisseur";
  ...
  TextEditingController _FouETBController = TextEditingController();
  TextEditingController _FouPICODController = TextEditingController();
  TextEditingController _FouEtatController = TextEditingController();
  TextEditingController _FouTiersController = TextEditingController();
  TextEditingController _FouDateFromController = TextEditingController();
  TextEditingController _FouDateToController = TextEditingController();
  TextEditingController _FouPINODuController = TextEditingController();
  TextEditingController _FouPINOToController = TextEditingController();
  ...
  Future<void> getPieceCLI() async {
    ...
    http.post(Uri.parse(myUrl),
        ...
        body: {
          ...
          "ETB":         Global.getETB() ,
          "DOS":          Global.getDOS(),
          "CE4":         _FouEtatController.text ,
          "Tiers":       _FouTiersController.text,
          "PICOD":       _FouPICODController.text,
          "date_debut":  _FouDateFromController.text,
          "date_fin":    _FouDateToController.text,
          "PINO1":       _FouPINODuController.text,
          "PINO2":       _FouPINOToController.text,

        }).then((response) {
      print('Response status : ${response.statusCode}');
      print('Response body : ${response.body}');
      print('Request : ETB:${_FouETBController.text } etat:${_FouEtatController.text } Tiers:${_FouTiersController.text } '
          'PICOD:${_FouPICODController.text } date:${_FouDateFromController.text } ${_FouDateToController.text } pino:${_FouPINODuController.text }');
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            // child: Row(
            //   children: [
            //     Expanded(flex:4,child: FilterTextField(label: 'Etablissement',controller: _FouETBController,)),
            ...
            // )) ,
              ...
              _buildText("Tiers"),
              SizedBox(height: 5.h,),
              dropdown_TIERS( TIERSController: _FouTiersController,) ,
              SizedBox(height: 15.h,),
              _buildText("Etat"),
              SizedBox(height: 5.h,),

              dropdown_Etat(EtatController: _FouEtatController),
              SizedBox(height: 15.h,),
              _buildText("Type Pièce"),
              SizedBox(height: 5.h,),
              dropdown_PICOD(PICODController: _FouPICODController),
              SizedBox(height: 15.h,),
              _buildText("date"),
              SizedBox(height: 5.h,),
              Row(
                children: [
                  ...
                  Expanded(flex:6,child: InputDate(DateController: _FouDateFromController,text: "date du",)),
                  Expanded(flex:1,child: Text("au",style: TextStyle(color: Colors.blueGrey),)),
                  Expanded(flex:6,child: InputDate(DateController: _FouDateToController,text: "jusqu'à")),
                ],
              ),
              ...
              Container(
                ...
                child: Row(children: [
                  Expanded(flex:4,child: FilterTextField(label: "du",controller:_FouPINODuController ,)),
                  const Expanded(flex:1,child: SizedBox(width: 10,)),
                  Expanded(flex:4,child: FilterTextField(label: "au",controller:_FouPINOToController ,))
